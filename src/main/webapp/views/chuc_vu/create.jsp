...
<div class="row">
    ...
    <div class="col-md-4">
        <label style="color: red;text-align: center"><h1>Chức Vụ</h1></label>
    </div>
    <div class="col-md-4"></div>
</div>
<form method="POST" action="/BTVN_war_exploded/chuc-vu/store">
<div class="row">
    <div class="col-md-12">
        <div>
        ...
        <div>
            ...
            <input type="text" class="form-control" required lang="vi" title="Không để trống" pattern="[a-zA-Z]*"  name="ten" id="exampleInputEmail12">
        </div>
    </div>
</div>
